...
async def ai_trade_insights(
    ...
    # ... existing trade data collection code stays the same ...
    ...
    try:
        ...
        return {"insights": insights, "summary": {
            ...
            print(f"Raw text was: {text[:500] if 'text' in locals() else 'no text'}")
...
## real time data from world bank
